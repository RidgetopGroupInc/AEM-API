...
run_name = 'Ex6_Fixed_ACCC_Solvent_Class_w_Single_Salt'# Run Name

## Define Non-ACCC Electrolyte Composition - Solvents and Salts
solvents = {} 
# No Non-ACCC Solvents are used

salts = {'LiPF6': 1.0}
# salts defined as LiPF6 at 1.0 (100%), proportion really only used if multiple salts defined and
...
## Define ACCC Solvent Class and attributes
# !!!The solvent definition file "ACCC Inputs (Solvent Class)--EC_EMC.txt" should be in same folder as executable
accc_solvent_class = 'EC_EMC'       # ACCC Inputs (Solvent Class)--EC_EMC.txt
number_of_accc_solvents = 2         # Number of solvents defined in the above ACCC Solvent Class
accc_solvent_proportions = [30, 70] # ACCC Solvent proportions (in same oreder that the solvents are defined in ACCC Solvent Class File)
number_of_total_solvents = 2   # Total number of solvents (ACCC and Non-ACCC Solvents)
...
aem = AEM_API(  electrolyte=electrolyte,
                accc_solvent_class= accc_solvent_class,
                ...
                accc_solvent_proportions = accc_solvent_proportions,
...
y = "diff_coeff"              # y-axis: Any column from chosen report 
