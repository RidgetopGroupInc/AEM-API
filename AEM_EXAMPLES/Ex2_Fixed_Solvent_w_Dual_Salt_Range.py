...
run_name = 'Ex2_Fixed_Solvents_Dual_Salt_Range'            # Run Name

## Define Non-ACCC Electrolyte Composition - Solvents and Salts
solvents = {'EC': 10, 'PC': 10, 'EMC': 15, 'MP': 20, 'DEGDME': 25, 'BN': 12, 'TMP': 5, 'VEC': 3} 
# solvents defines ethylene carbonate 10%, propylene carbonate 10%, ethylmethyl carbonate 15%, ect... 
# proportions do not need to add up to 100%, values will be normalized
salts = {'LiPF6': 0.5, 'LiFSI': 0.5}
# salts defined are LiPF6 at 0.5 (50%) and LiFSi at 0.5 (50%), proportion really only used if multiple salts defined and
...
number_of_total_solvents = 8   # Total number of solvents (ACCC and Non-ACCC Solvents)
