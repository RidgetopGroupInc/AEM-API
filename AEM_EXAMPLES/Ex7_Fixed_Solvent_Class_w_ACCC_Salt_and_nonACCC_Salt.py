...
run_name = 'Ex7_Fixed_Solvent_Class_w_Single_ACCC_Salt'# Run Name

## Define Non-ACCC Electrolyte Composition - Solvents and Salts
solvents = {'PC': 100} 
# Solvent Propylene Carbonate is only Solvent used

salts = {'LiPF6': 50}
# salts defined as LiPF6 at 50%, proportion really only used if multiple salts defined and
...
## Define ACCC Salt Class and attributes
# !!!The salt definition file "ACCC Inputs (Salt Class)--LiBOB_w_PC_EA.txt" should be in same folder as executable
accc_salt_class = 'LiBOB_w_PC_EA'       # ACCC Inputs (Salt Class)--LiBOB_w_PC_EA.txt
accc_salt_proportions = [50]            # proportion for accc salt in mixture              
number_of_accc_solvents = 0             # Number of solvents defined in the above ACCC Solvent Class
number_of_total_solvents = 1            # Total number of solvents (ACCC and Non-ACCC Solvents)
number_of_total_salts = 2               # Total number of salts (ACCC and Non-ACCC Salts)
number_of_accc_salts = 1                # Number of ACCC Salts (None used in this example)
...
totalsaltconc = 3             # Max. Total Salt Concentration of Interest (Required if salt concentration mode is 1)
...
aem = AEM_API(  electrolyte=electrolyte,
                accc_salt_class= accc_salt_class,
                ...
                accc_salt_proportions = accc_salt_proportions,
...
report_no = "Report01"   # Report01-20 
x = "m2"                 # x-axis: Any column from chosen report 
y = "spec_cond"              # y-axis: Any column from chosen report 
