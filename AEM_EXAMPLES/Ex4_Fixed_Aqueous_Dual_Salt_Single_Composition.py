...
run_name = 'Ex4_Fixed_Aqueous_Dual_Salt_Single_Composition'            # Run Name

## Define Non-ACCC Electrolyte Composition - Solvents and Salts
solvents = {'water': 100} 
# solvents defines water
# proportions do not need to add up to 100%, values will be normalized
salts = {'LiNO3': 0.5, 'Na2SO4': 0.5}
# salts defined is LiNO3 at 0.5 (50%) and NA2SO4 at 0.5 (50%), proportion really only used if multiple salts defined and
...
totalsaltconc = 15              # Max. Total Salt Concentration of Interest (Required if salt concentration mode is 1)
tmin = 0                      # Minimum Temperature: -30deg to 60 deg (Do not exceed 100deg)
tmax = 70                      # Maximum Temperature: -30deg to 60 deg (Do not exceed 100deg)
